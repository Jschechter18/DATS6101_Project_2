...
# Data Preprocessing and Feature Explanations

The dataset contains 5000 observations, each being a row that represents students. There were 23 total features, where we selected the following eight of which as features of importance:
...
**Random Forest**
 ...
 - True pass rate 53.35%
 - True fail rate 98.42%
 - AUC(ROC): 0.896
