...
print(rf_model)
```
Our main goal is to predict whether a student will pass or fail, using a Random Forest model, which is a powerful ensemble learning method.
...
**ROC Curve**:
As a rule of thumb, an AUC greater than 0.8 is considered good, and anything above 0.85 is excellent.
- AUC = 0.896 , excellent!
- This means that the model is highly capable to distinguish between pass and fail students 89.6% of the time.
